...
제한사항
현재 시각 P는 string형으로 주어집니다. 오전과 오후는 각각 문자열 AM, PM으로 표시하고, 시간은 12시간 단위로 표시되며, :를 기준으로 시, 분, 초를 나눠 시:분:초로 표시됩니다. 시, 분, 초는 각각 두자리 숫자로 이루어져 있으며, 24시간 단위 표시로 변환한 결과도 각각 두자리 숫자여야 합니다. 한자리 숫자일 경우, 앞에 0을 붙이면 됩니다. (ex. 오후 5시 5분 5초를 12시간 단위로 표시하면 PM 5:5:5가 아닌 PM 05:05:05로 표시되며, 24시간 단위로 표시하면 20:05:05로 표시됩니다.)
